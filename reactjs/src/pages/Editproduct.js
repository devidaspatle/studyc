...
function Editproduct() {
    ...
    useEffect(() => {
        ...
        .then(function (response) {
            ...
            setId(product.id);
            setShop_name(product.shop_name);
            setProduct_name(product.product_name);
            setCategory_name(product.category_name);
            setAuthor_name(product.author_name);
            setPrice(product.price);
            setDiscount_price(product.discount_price);
            setIbsn_number(product.ibsn_number);
            setAdditional_year(product.additional_year);
        })
    ...
    const handleSave = () => {
        setIsSaving(true);
        axios.patch(`http://localhost:4000/api/products/${id}`, {
            shop_name: shop_name,
 ...
 <form action="/editproduct" method="post" name="frm">
